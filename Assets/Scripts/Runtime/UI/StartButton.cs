...
{
      Destroy(GameStartPrefab);
  Vector3 localPosition = Camera.current.ViewportToScreenPoint(new Vector3(0.5f, 0.5f));; // some logic for getting the local position relative to the board
